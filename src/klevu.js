...
var version = "2.4.2"; //current version
...
template: function () {
  ...
  setHelper("escapeHTML", escapeHTML);
...
// kmcObject
  var kmcInputs = {
      markAllResourcesLoaded: function (){
          ...
          /* DEBUG CODE START */
          if ( klevu.getGlobalSetting("console.type.kmc") ) {
              klevu.logDebug( "KMC - Data ready to be used" );
          }
          /* DEBUG CODE END */
      ...
      removeIneligibleBanners: function (klevu_banner) {
          ...
          var today = new Date, startDate, endDate, removeCurrent = false;
          today.setHours(0,0,0,0);
          for (var i = 0; i < klevu_banner.length; i++ ) {
              startDate = new Date (klevu_banner[i].startDate);removeCurrent = false;
      ...
      sortAutocorrectMap: function (klevu_autoCorrectMap){
          var maxLength=0,i=0,len1=0,len2=0,temp,currLength=0,j=0;
          for(i=0,len1=klevu_autoCorrectMap.length;i<len1;i++){
              ...
              for(j= i+1,len2=klevu_autoCorrectMap.length;j<len2;j++){
                  ...
                  if(maxLength<currLength){maxLength=currLength;temp=klevu_autoCorrectMap[i];
                      klevu_autoCorrectMap[i]=klevu_autoCorrectMap[j];klevu_autoCorrectMap[j]=temp;}}}
      ...
      showProductRatingLanding: function () {
          ...
          return (typeof klevu_uc_userOptions !== "undefined" && typeof klevu_uc_userOptions.showRatingsOnSearchResultsLandingPage !== "undefined" ? klevu_uc_userOptions.showRatingsOnQuickSearches : kmcData)
      },
      ...
      showProductRatingCatnav: function () {
          ...
          return (typeof klevu_uc_userOptions !== "undefined" && typeof klevu_uc_userOptions.showRatingsOnCategoryPage !== "undefined" ? klevu_uc_userOptions.showRatingsOnQuickSearches : kmcData)
      }
  };
      ...
      fire: function(data,scope){
          ...
          if(!klevu.isUndefined(apiKey)){
              ...
              if(!klevu.getObjectPath(data,"constants.COOKIE_KLEVU_RCP",false)){
                  ...
                  /* DEBUG CODE START */
                  if ( klevu.getGlobalSetting("console.type.kmc") ) {
                      klevu.logDebug( "KMC - Cookie constant set" );
                  }
                  /* DEBUG CODE END */
              }
              ...
              /* DEBUG CODE START */
              if ( klevu.getGlobalSetting("console.type.kmc") ) {
                  klevu.logDebug( "KMC - Api key found , Starting KMC powerUp" );
              }
              /* DEBUG CODE END */
              ...
              if(klevu.isUndefined(kmcDictionary)){
                  ...
                  /* DEBUG CODE START */
                  if ( klevu.getGlobalSetting("console.type.kmc") ) {
                      klevu.logDebug( "KMC - dictionary set" );
                  }
                  /* DEBUG CODE END */
              }
              ...
              if(apiKey !== kmcData){
                  ...
                  /* DEBUG CODE START */
                  if ( klevu.getGlobalSetting("console.type.kmc") ) {
                      klevu.logDebug( "KMC - KMC data set from localStorage" );
                  }
                  /* DEBUG CODE END */
              }
              ...
              if(kmcRefresh){
                  ...
                  if((klevu.isUndefined(kmcLoading) || kmcLoading === false)){
                      ...
                      /* DEBUG CODE START */
                      if ( klevu.getGlobalSetting("console.type.kmc") ) {
                          klevu.logDebug( "KMC - File loading started" );
                      }
                      /* DEBUG CODE END */
                  }
              } else {
                  /* DEBUG CODE START */
                  if ( klevu.getGlobalSetting("console.type.kmc") ) {
                      klevu.logDebug( "KMC - File loading skipped" );
                  }
                  /* DEBUG CODE END */
                  klevu.search.modules.kmcInputs.base.markAllResourcesLoaded();
              }
...
name : "buildSearch" , fire : function () {
  console.log('buildSearch ', { isInteractive: klevu.isInteractive, search: klevu.search, build: klevu.search.build, settings: klevu.settings, localSetting: klevu.getSetting( klevu.settings , "settings.localSettings" , false ) });
...
console.log('Attaching bindallSearchboxes');
...
// console.log('klevu options', options)
// var searchBoxSelector = klevu.getSetting( klevu.settings , "settings.search.searchBoxSelector" , klevu.randomId() );
// console.log('searchBoxselector=', searchBoxSelector)
// var list = klevu.dom.find( searchBoxSelector );
// console.log('searchbox List=', list);
...
collect: function (data) {
  ...
  /* DEBUG CODE START */
  if (klevu.settings.console.type.event) {
    klevu.logDebug("Event - Analytics - Collection");
  }
  /* DEBUG CODE END */
              ...
              sendAnalyticsEventsFromStorage: function(dictionary){
                  ...
                  klevu.each(storedEvents, function (key, value) {
                      ...
                      if(klevu.getObjectPath(value,"status","new") === "pending") {
                          ...
                          if((klevu.time.timestamp() - klevu.getObjectPath(value,"statusTime",klevu.time.timestamp()))<30){
                              return;
                          } else {
                      ...
                      if("timestamp" in value){
                          ...
                          if((currentTime - parseInt(value.timestamp)) > 21600){
                              klevu.analytics.utility.removeAnalyticsEventsFromStorage(dictionary,key);
                              return;
                          }
                      }
                      ...
                      if(value.type === "collect"){
                          ...
                          klevu.analyticsEvents.collect({toSend:value,callbacks:callbacks});
                      }
                  });
...
// abTestObject
  var abTest = {
      markAllResourcesLoaded: function (setOnPage){
          ...
          /* DEBUG CODE START */
          if ( klevu.getGlobalSetting("console.type.abtest") ) {
              klevu.logDebug( "ABTEST - Data ready to be used" );
          }
          /* DEBUG CODE END */
      ...
      usageTrack:function(abTestString,type){
          ...
          var requestDetails = {
              success: function (data, options, status, isSuccess) {
                  ...
                  /* DEBUG CODE START */
                  if ( klevu.getGlobalSetting("console.type.abtest") ) {
                      klevu.logDebug( "ABTEST - Usage confirmed" );
                  }
                  /* DEBUG CODE END */
              },
              error: function (data, options, status, isSuccess) {
                  /* DEBUG CODE START */
                  if ( klevu.getGlobalSetting("console.type.abtest") ) {
                      klevu.logDebug( "ABTEST - Usage error" );
                  }
                  /* DEBUG CODE END */
              },
              options: options
...
klevu.settings.chains.initChain.add(
  {
      ...
      fire: function(data,scope){
          ...
          if(!klevu.isUndefined(apiKey)){
              ...
              /* DEBUG CODE START */
              if ( klevu.getGlobalSetting("console.type.abTest") ) {
                  klevu.logDebug( "abTest - Api key found , Starting abTest powerUp" );
              }
              /* DEBUG CODE END */
              ...
              if(klevu.isUndefined(abtestDictionary)){
                  ...
                  /* DEBUG CODE START */
                  if ( klevu.getGlobalSetting("console.type.abTest") ) {
                      klevu.logDebug( "abTest - dictionary set" );
                  }
                  /* DEBUG CODE END */
              }
              ...
              if(apiKey !== abTestData){
                  ...
                  /* DEBUG CODE START */
                  if ( klevu.getGlobalSetting("console.type.abTest") ) {
                      klevu.logDebug( "abTest - abTest data set from localStorage" );
                  }
                  /* DEBUG CODE END */
              }
              ...
              if(abTestRefresh){
                  ...
                  if((klevu.isUndefined(abTestLoading) || abTestLoading === false)){
                      ...
                      /* DEBUG CODE START */
                      if ( klevu.getGlobalSetting("console.type.abTest") ) {
                          klevu.logDebug( "abTest - File loading started" );
                      }
                      /* DEBUG CODE END */
                  }
              } else {
                  /* DEBUG CODE START */
                  if ( klevu.getGlobalSetting("console.type.abTest") ) {
                      klevu.logDebug( "abTest - File loading skipped" );
                  }
                  /* DEBUG CODE END */
...
fire: function (data, scope) {
  ...
  if (filesLeft > 0) {
    /* DEBUG CODE START */
    if (klevu.settings.console.type.recs) {
      logInfo("RECS - A new load can not start as last one did not finish");
    }
    /* DEBUG CODE END */
  }
...
fire: function (data, scope) {
  ...
  if (!data.apiKey) {
    /* DEBUG CODE START */
    if (klevu.settings.console.type.recs) {
      logInfo("RECS - API key can not be detected");
    }
    /* DEBUG CODE END */
    return false;
  }
...
fire : function ( data , scope ) {
  ...
  if ( data.context.doCall ) {
    ...
    /* DEBUG CODE START */
    if ( klevu.settings.console.type.ajax ) {
      klevu.logError( "chains.actions.doCall - makeRequest - Request object is not present or request was forced stopped." );
      klevu.logDebug( "chains.actions.doCall - makeRequest - Data:" );
      klevu.logDebug( data );
    }
    /* DEBUG CODE END */
